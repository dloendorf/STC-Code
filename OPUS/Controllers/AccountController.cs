        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                if (!await UserManager.IsEmailConfirmedAsync(user.Id))
                {
                    ...
                    ViewBag.errorMessage = "You must have a confirmed email to log on. A confirmation email has been sent.";
                    return View("Error");
                }
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ViewBag.Message = "An OPUS website administrator will send you an email. Check your email and confirm your account. You must be confirmed before you can log in."
                                    + " If the email does not show up in a few hours, check your Junk folder! NOTE: If you are not allowed on this site a confirming email WILL NOT be sent.";
